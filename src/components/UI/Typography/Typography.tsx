...
export const variantMap: Record<Variant, { tag: keyof JSX.IntrinsicElements; className: string }> =
  {
    h1: { tag: 'h1', className: 'text-4xl font-extrabold tracking-tight text-textCol' },
    h2: { tag: 'h2', className: 'text-2xl font-normal tracking-tight first:mt-0 text-textCol' },
    h3: { tag: 'h3', className: 'text-lg font-normal tracking-tight' },
    h4: { tag: 'h4', className: 'text-sm font-normal tracking-tight' },
    body1: { tag: 'p', className: 'leading-7 align-center text-textSemiCol' },
